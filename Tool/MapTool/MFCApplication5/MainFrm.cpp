...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0
		, 0
		, RUNTIME_CLASS(CMyForm)
		, CSize(600, 300)
		, pContext);

	m_MainSplitter.CreateView(1
		, 0
		, RUNTIME_CLASS(CMFCApplication5View)
		, CSize(600, 300)
		, pContext);
	
	m_pMainForm = (CMyForm*)m_MainSplitter.GetPane(0, 0);
	m_pMainView = (CMFCApplication5View*)m_MainSplitter.GetPane(1, 0);
