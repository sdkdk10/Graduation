...
struct VertexIn_BillBoard
{
	float3 PosW  : POSITION;
	float2 SizeW : SIZE;
};

struct VertexOut_BillBoard
{
...
VertexOut_BillBoard VS(VertexIn_BillBoard vin)
{
	VertexOut_BillBoard vout;

	// Just pass data over to geometry shader.
	vout.CenterW = vin.PosW;
	vout.SizeW   = vin.SizeW;

	//vout.CenterW = float3(-10, -10, 0);
	//vout.SizeW = float2(5, 10);
...
[maxvertexcount(4)]
void GS(point VertexOut_BillBoard gin[1],
        uint primID : SV_PrimitiveID, 
