...
{
public:
	enum RenderType { RENDER_PRIORITY, RENDER_SHADOW, RENDER_NONALPHA_FORWARD, RENDER_NONALPHA_INSTANCING, RENDER_NONALPHA_DEFFERD, RENDER_ALPHA_INST, RENDER_ALPHA_DEFAULT, RENDER_ALPHA_SPRITE, RENDER_UI, RENDER_UICHANGE, RENDER_FADE, RENDER_END};
