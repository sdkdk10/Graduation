...
class AnimateStateMachine_RockWarrior
	: public AnimateStateMachine
{
public:

public:
	explicit AnimateStateMachine_RockWarrior(CGameObject* pObj, wchar_t* pMachineName, int SoundFrame[State::STATE_END], int EffectFrame[State::STATE_END]);
	virtual ~AnimateStateMachine_RockWarrior();
private:
	HRESULT			Initialize();
...
public:
	static AnimateStateMachine_RockWarrior* Create(CGameObject* pObj, wchar_t* pMachineName, int SoundFrame[State::STATE_END], int EffectFrame[State::STATE_END]);
