...
class AnimateStateMachine_Spider
	: public AnimateStateMachine
{
public:

public:
	explicit AnimateStateMachine_Spider(CGameObject* pObj, wchar_t* pMachineName, int SoundFrame[State::STATE_END], int EffectFrame[State::STATE_END]);
	virtual ~AnimateStateMachine_Spider();
private:
	HRESULT			Initialize();
...
public:
	static AnimateStateMachine_Spider* Create(CGameObject* pObj, wchar_t* pMachineName, int SoundFrame[State::STATE_END], int EffectFrame[State::STATE_END]);
