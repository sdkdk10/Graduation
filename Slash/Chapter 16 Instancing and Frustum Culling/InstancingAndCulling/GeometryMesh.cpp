...
GeometryMesh::GeometryMesh(Microsoft::WRL::ComPtr<ID3D12Device> d3dDevice) : Mesh(d3dDevice)
{
...
HRESULT GeometryMesh::Initialize()
{
	GeometryGenerator geoGen;
	GeometryGenerator::MeshData box = geoGen.CreateBox(1.0f, 1.0f, 1.0f, 3);
	GeometryGenerator::MeshData grid = geoGen.CreateGrid(10.0f, 10.0f, 50,50);
...
int GeometryMesh::Update(const GameTimer & gt)
{
	return 0;
}
